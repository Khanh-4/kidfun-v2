...
function registerLockShortcuts() {
  // Phím tắt bí mật để thoát lock screen (cho demo/testing)
  // Ctrl+Shift+Alt+Q — khó nhấn nhầm
  try {
    globalShortcut.register('Ctrl+Shift+Alt+Q', () => {
      console.log('[Main] Emergency unlock: Ctrl+Shift+Alt+Q pressed');
      if (lockWindow && !lockWindow.isDestroyed()) {
        destroyLockScreen();
        // Thông báo renderer để cập nhật state
    ...
    console.warn('Could not register emergency unlock shortcut:', err.message);
  }
