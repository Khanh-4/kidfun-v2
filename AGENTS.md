...
This project is indexed by GitNexus as **kidfun-v2** (2499 symbols, 3799 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
