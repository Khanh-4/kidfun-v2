...
This project is indexed by GitNexus as **kidfun-v2** (633 symbols, 1053 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
