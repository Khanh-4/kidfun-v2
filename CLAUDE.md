...
This project is indexed by GitNexus as **kidfun-v2** (651 symbols, 1072 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
